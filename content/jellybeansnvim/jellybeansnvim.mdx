...
<PhotoGrid images={["dark_1.png", "dark_2.png"]} />
<PhotoGrid images={["light_1.png", "light_2.png"]} />

I wrote a neovim theme called Jellybeans.nvim. It's a port of the popular Jellybeans theme for Vim. It's a dark theme with a lot of colors. It's a bit different from the original Jellybeans theme, but I think it captures the spirit of the original. It also includes a light variant and support for many popular plugins.
